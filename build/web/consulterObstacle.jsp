<%-- 
    Document   : consulterObstacle
    Created on : 23 juil. 2018, 18:27:43
    Author     : ghost
--%>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <form action="${pageContext.request.contextPath}/obstacle">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${listObs}" var="obs">
                                    <tr>
                                        <td>${obs.numObstacle}</td>
                                          <td>${obs.nomObstacle}</td>
                                          <td>${obs.niveau}</td>
                                            <td>${obs.noteMin}</td>
                                              <td>${obs.temps}</td>
