 <%-- 
    Document   : PlaniferParcours
    Created on : 15 juil. 2018, 12:51:07
    Author     : ghost
--%>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="parcours?action=loadPlanifier">Planifer Parcours</a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="container" id="boiteMere">
                        ...
                        <br><h3><center>Planifier Parcours</center></h3><br>
                        <form class="col-md-12  mx-auto " action="${pageContext.request.contextPath}/parcours" method="POST" >
                            ...
                            <div>
                                ...
                                <input  class="form-control" type="text" id="numPassage" name="numPassage" required/>
                            </div>
                            <div>
                                <label class="control-label">Date</label>
                                <input  class="form-control" type="date" id="date" name="date" required/>
                            </div><br>
                               <input type="button" value="Nouveau obstacle" class="btn btn-block btnadd">
                            <div class="addObstacle">
                            </div><br>
                            
                            <div class="addProd">
                                <p>Instructeur</p>
                                <select class="form-control" id="instructeur" name="instructeur" required>
                                    <option>Choisir soldat</option>
                                    <c:forEach items="${ListSolda}" var="soldat">
                                        <option value="${soldat.matricule}">${soldat.matricule}</option>
                                    </c:forEach>
                                </select>
                            </div><br>
                            
                             <input type="button" value="ajouter soldat" class="btn btn-block btnaddSold">
                            <div class="addSoldat">                                     
                            </div>
