<%-- 
    Document   : obstacle
    Created on : 14 juil. 2018, 21:40:04
    Author     : ghost
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="container" id="boiteMere">
                        ...
                        <br><h3><center>Ajout Obstacle</center></h3><br>
                        <form class="col-md-12  mx-auto " action="${pageContext.request.contextPath}/obstacle" method="POST" >
                            <input type="hidden" name="action" value="addObstacle">
                            <div>
                                <label class="control-label">Numero obstacle</label>
                                <input  class="form-control" type="text" name="numObstacle" required/>
                            </div>
                            <div>
                                <label class="control-label">Nom Obstacle</label>
                                <input  class="form-control" type="text" name="nomObstacle" required/>
                            </div>
                            <div>
                                <p>Niveau</p>
                                <select class="form-control" name="niveau" required>
                                    <option>Choisir niveau</option>
                                    <c:forEach items="${listNiv}" var="niv">
                            ...
                            <div>
                                ...
                                <input  class="form-control" type="text" name="temps" required/>
                            </div>
                             <div>
                                <label class="control-label">Note minimale</label>
                                <input  class="form-control" type="text" name="noteMin" required/>
                            </div>
