<%-- 
    Document   : ConsulterSoldat
    Created on : 18 juil. 2018, 23:54:30
    Author     : ghost
--%>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <form action="${pageContext.request.contextPath}/soldat">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${listSoldat}" var="soldat">
                                    <tr>
                                        <td>${soldat.matricule}</td>
                                          <td>${soldat.prenom}</td>
                                          <td>${soldat.nom}</td>
                                            <td>${soldat.tel}</td>
                                              <td>${soldat.email}</td>
                                                <td>${soldat.grade}</td>
                                                  <td>${soldat.typeSoldat}</td>
                                    </tr>
                                </c:forEach>
