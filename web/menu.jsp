<%-- 
    Document   : menu
    Created on : 28 juin 2018, 10:46:27
    Author     : ghost
--%>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="soldat?action=Loadtableau">Consulter Soldat</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                       ...
                       <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="parcours?action=loadPlanifier">Planifier Parcours</a></li>
